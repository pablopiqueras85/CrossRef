...
from .fetcher import DEFAULT_USER_AGENT, WebFetcher
...
class WebCatalogSource:
    ...
    def __init__(self, config: dict[str, Any], client: httpx.Client | None = None) -> None:
        ...
        self._fetcher = WebFetcher(config, client)
        self.max_pages = self._fetcher.max_pages
    ...
    def get(self, url: str) -> str | None:
        """HTML de una pagina, respetando robots.txt, ritmo y cache."""
